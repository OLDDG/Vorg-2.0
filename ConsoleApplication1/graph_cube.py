...
f = open('C:\Users\zigmu\OneDrive\Рабочий стол\vorg\OLDDG\Vorg-2.0\ConsoleApplication1\Debug\Values.txt', 'r')
...
ani.save('cube.gif', writer=animation.PillowWriter(fps=20))
